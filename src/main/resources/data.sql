...
INSERT INTO veterinario
    (email, nome, registrocrmv)
VALUES
    ('vet@novo.com', 'Doolittle', 'SP-12345');

INSERT INTO tutor
    (cpf, email, endereco, nome, rg, telefone)
VALUES
    ('123.456.789-01', 'tutor@do.toto', 'endereco', 'It\'s me Mario', 'Rgdsadsa', '(23) 4567890132');

INSERT INTO clinica
    (nome_fantasia,razao_social,cnpj,cnae,cep,logradouro,numero,bairro,cidade,estado,responsavel_tecnico,email)
VALUES
    ("cLI","Teste", "65.622.164/0001-04","46546","03808-130","Rua Miguel Rachid", "546","Vila Paranaguá","São Paulo","AM","resp. tecnico","teste");
